                ...
                if(!func.flags.contains(Flag.NO_IMPLEMENTATION)) {
                    ...
                    for(BytecodeInstruction instr : bc.getInstructions()) {
                        ...
                        if(instr.instruction == BytecodeInstructions.PUSHI8) {
                            ...
                            writer.write("    mov byte al, [rsp]\n");
                            writer.write("    inc rsp\n");
                            writer.write("    mov byte [" + compiled.getFields().get((short) instr.data[0]).name + "], al\n");
                        } else if(instr.instruction == BytecodeInstructions.SETSTATICFIELD16) {
                            writer.write("    pop ax\n");
                            writer.write("    mov word [" + compiled.getFields().get((short) instr.data[0]).name + "], ax\n");
                        } else if(instr.instruction == BytecodeInstructions.SETSTATICFIELD32) {
                            writer.write("    mov dword eax, [rsp]\n");
                            writer.write("    add rsp, 4\n");
                            writer.write("    mov dword [" + compiled.getFields().get((short) instr.data[0]).name + "], eax\n");
                        } else if(instr.instruction == BytecodeInstructions.SETSTATICFIELD64) {
                            writer.write("    pop rax\n");
                            writer.write("    mov qword [" + compiled.getFields().get((short) instr.data[0]).name + "], rax\n");
                        } else if(instr.instruction == BytecodeInstructions.GETSTATICFIELD8) {
                            writer.write("    mov byte al, [" + compiled.getFields().get((short) instr.data[0]).name + "],\n");
                            writer.write("    dec rsp\n");
                            writer.write("    mov byte [rsp], al\n");
                        } else if(instr.instruction == BytecodeInstructions.GETSTATICFIELD16) {
                            writer.write("    mov word ax, [" + compiled.getFields().get((short) instr.data[0]).name + "],\n");
                            writer.write("    push ax\n");
                        } else if(instr.instruction == BytecodeInstructions.GETSTATICFIELD32) {
                            writer.write("    mov dword eax, [" + compiled.getFields().get((short) instr.data[0]).name + "],\n");
                            writer.write("    sub rsp, 4\n");
                            writer.write("    mov dword [rsp], eax\n");
                        } else if(instr.instruction == BytecodeInstructions.GETSTATICFIELD64) {
                            writer.write("    mov qword rax, [" + compiled.getFields().get((short) instr.data[0]).name + "]\n");
                            writer.write("    sub rsp, 8\n");
                            writer.write("    mov qword [rsp], rax\n");
                            ...
                            writer.write("    sub rsp, 8\n");
                            writer.write("    mov qword [rsp], rax\n");
                        } else if(instr.instruction == BytecodeInstructions.SUB8) {
                            writer.write("    mov byte ah, [rsp]\n");
                            writer.write("    inc rsp\n");
                            writer.write("    mov byte al, [rsp]\n");
                            writer.write("    inc rsp\n");
                            writer.write("    sub al, ah\n");
                            writer.write("    dec rsp\n");
                            writer.write("    mov byte [rsp], al\n");
                        } else if(instr.instruction == BytecodeInstructions.SUB16) {
                            writer.write("    pop bx\n");
                            writer.write("    pop ax\n");
                            writer.write("    sub ax, bx\n");
                            writer.write("    push ax\n");
                        } else if(instr.instruction == BytecodeInstructions.SUB32) {
                            writer.write("    mov dword ebx, [rsp]\n");
                            writer.write("    add rsp, 4\n");
                            writer.write("    mov dword eax, [rsp]\n");
                            writer.write("    add rsp, 4\n");
                            ...
                            writer.write("    sub rsp, 4\n");
                            writer.write("    mov dword [rsp], eax\n");
                        } else if(instr.instruction == BytecodeInstructions.SUB64) {
                            writer.write("    mov qword rbx, [rsp]\n");
                            writer.write("    add rsp, 8\n");
                            writer.write("    mov qword rax, [rsp]\n");
                            writer.write("    add rsp, 8\n");
                            ...
                            writer.write("    push ax\n");
                        } else if(instr.instruction == BytecodeInstructions.SHR32) {
                            writer.write("    mov dword ecx, [rsp]\n");
                            writer.write("    add rsp, 4\n");
                            writer.write("    mov dword eax, [rsp]\n");
                            writer.write("    add rsp, 4\n");
                            ...
                            writer.write("    sub rsp, 4\n");
                            writer.write("    mov dword [rsp], eax\n");
                        } else if(instr.instruction == BytecodeInstructions.SHR64) {
                            writer.write("    mov qword rcx, [rsp]\n");
                            writer.write("    add rsp, 8\n");
                            writer.write("    mov qword rax, [rsp]\n");
                            writer.write("    add rsp, 8\n");
